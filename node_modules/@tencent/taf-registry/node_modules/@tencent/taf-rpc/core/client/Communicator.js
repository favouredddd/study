...
Communicator.prototype.initialize  = function ($sFilePath) {
    ...
    this._configure.parseFile($sFilePath || process.env.TAF_CONFIG);
...
Communicator.prototype.bindUpdateLocatorEvent = function () {
    ...
    function updateLocator()
    {
        ...
        var locator = config.get("taf.application.client.locator", undefined);
    ...
    if(!global._tafRpcEvents)
    {
        ...
        process.on('message', function(message) {
            global._tafRpcEvents.emit('message', message);
        });
    }

    global._tafRpcEvents.on('message', function(message){
        if (message && message.cmd === 'taf.loadproperty') {
            updateLocator();
        }
    });
};
