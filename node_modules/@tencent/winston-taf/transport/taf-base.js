...
var mkdirp = require('@tencent/super-mkdirp');
...
var TafBase = function (options) {
	...
	this.options = {
		interval : options.interval || 5 * 1000, //5s
...
util.inherits(TafBase, winston.Transport);

TafBase.prototype.name = 'tafBase';

TafBase.prototype.log = function (level, msg, meta, callback) {
...
TafBase.prototype._write = function(data, callback) {
	var ths = this;
...
TafBase.prototype._checkfile = function(cb) {
	this.emit('checkfile');
...
TafBase.prototype._checkdir = function(cb) {
	var ths = this;
...
TafBase.prototype._getFileStream = function() {
	var ths = this;
...
TafBase.prototype._closeStream = function() {
	if (this._stream) {
		this._stream.removeAllListeners('error');
		
		//fixme? maybe end with error?
...
TafBase.prototype.close = function() {
	if (this._timerid) {
...
module.exports = winston.transports.TafBase = TafBase;