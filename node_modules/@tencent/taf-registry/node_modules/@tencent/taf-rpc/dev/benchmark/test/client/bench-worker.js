var net = require('net'), tm = require('timers');
...
exports.run = function(id, options) {
    ...
    Request.ServantName = "testss";
    Request.sFuncName   = "getUsrName";
	...
	function next() {
        ...
        os.writeString(1, "kevintian_AA" + index.toString());
        Request.Arguments = os.getBinBuffer();

		conn.write(stream.compose(Request));
	}
	// 每秒统计
	function second() {
	...
	conn.on('error', function() {
		result.err++;
		console.log("CNNECT ERROR:", opt.host, opt.port);
	});
