...
describe('test raw in map', function() {
    ...
    it("#test for map<string,long>", function (){
        var mapValue = new Taf.Map(Taf.String, Taf.Int64, 1, 1);
        ...
        var decodeMap = is.readMap(0, true, Taf.Map(Taf.String, Taf.Int64, 1, 1));
    ...
    it("#test for map<long,string>", function() {
        var mapValue = new Taf.Map(Taf.Int64, Taf.String, 1, 1);
        ...
        os.writeMap(0, mapValue);
        var is  = new Taf.JceInputStream(os.getBinBuffer());
        var decodeMap = is.readMap(0, true, Taf.Map(Taf.Int64, Taf.String, 1, 1));
        decodeMap.size().should.equal(4);
    ...
    it("#test for map<string,map<long,string>>", function() {
        var mapValue = new Taf.Map(Taf.String, Taf.Map(Taf.Int64, Taf.String, 1, 1));

        var value = new Taf.Map(Taf.Int64, Taf.String, 1, 1);
        ...
        os.writeMap(0, mapValue);
        var is  = new Taf.JceInputStream(os.getBinBuffer());
        var decodeMap = is.readMap(0, true, Taf.Map(Taf.String, Taf.Map(Taf.Int64, Taf.String, 1, 1)));
    ...
    it("#test for list<map<long,string>>", function() {
        var listValue = new Taf.List(Taf.Map(Taf.Int64, Taf.String, 1, 1));
        var value = new Taf.Map(Taf.Int64, Taf.String, 1, 1);
        value.insert("-9223372036854775808", Buffer.from("value1"));
        value.insert("-9223372036854775802", Buffer.from("value2"));
        value.insert("9223372036854775807", Buffer.from("value3"));
        ...
        var is  = new Taf.JceInputStream(os.getBinBuffer());
        var decodeList = is.readList(0, true, Taf.List(Taf.Map(Taf.Int64, Taf.String, 1, 1)));
