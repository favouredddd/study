...
describe("test number", function() {
    ...
    describe("test for int8",function(){
        it("#encode and decode", function (){
            ...
            var decodeInt8 = is.readInt8(0,true,Taf.Int8);
    ...
    describe("test for int16",function(){
        it("#encode and decode", function (){
            ...
            var is  = new Taf.JceInputStream(os.getBinBuffer());
            var decodeInt16 = is.readInt16(0,true,Taf.Int16);
    ...
    describe("test for int32",function(){
        it("#encode and decode", function (){
            ...
            var is  = new Taf.JceInputStream(os.getBinBuffer());
            var decodeInt32 = is.readInt32(0,true,Taf.Int32);
    ...
    describe("test for int64",function(){
        it("# <= 2^53-1  bString = false ", function (){
            ...
            var is  = new Taf.JceInputStream(os.getBinBuffer());
            var decodeInt64 = is.readInt64(0,true,Taf.Int64);
        ...
        it("# > 2^53-1  bString = true ", function (){
            ...
            var is  = new Taf.JceInputStream(os.getBinBuffer());
            var decodeInt64 = is.readInt64(0,true,Taf.Int64,true);
            decodeInt64.should.equal(encodeInt64);
        ...
        if("BigInt" in global){
            it("# > 2^53-1  bString = 2 ", function (){
                ...
                var is  = new Taf.JceInputStream(os.getBinBuffer());
                var decodeInt64 = is.readInt64(0,true,Taf.Int64,2);
                decodeInt64.should.equal(encodeInt64);
    ...
    describe("test for uint8",function(){
        it("#encode and decode", function (){
            ...
            var is  = new Taf.JceInputStream(os.getBinBuffer());
            var decodeUInt8 = is.readUInt8(0,true,Taf.UInt8);
    ...
    describe("test for uint16",function(){
        it("#encode and decode", function (){
            ...
            var is  = new Taf.JceInputStream(os.getBinBuffer());
            var decodeUInt16 = is.readUInt16(0,true,Taf.UInt16);
    ...
    describe("test for uint32",function(){
        it("#encode and decode", function (){
            ...
            var is  = new Taf.JceInputStream(os.getBinBuffer());
            var decodeUInt32 = is.readUInt32(0,true,Taf.UInt32);
    ...
    describe("test for float",function(){
        it("#encode and decode", function (){
            ...
            var is  = new Taf.JceInputStream(os.getBinBuffer());
            var decodeFloat = is.readFloat(0,true,Taf.Float);
    ...
    describe("test for double",function(){
        it("#encode and decode", function (){
            ...
            var is  = new Taf.JceInputStream(os.getBinBuffer());
            var decodeDouble = is.readDouble(0,true,Taf.Double);
