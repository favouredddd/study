...
<html lang="en">
<head>
    <title>Code coverage report for taf-rpc\core\client\ServantProxy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">taf-rpc/core/client/</a> ServantProxy.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
ServantProxy.prototype.setTimeout  = <span class="fstat-no" title="function not covered" >function (iTimeout) {</span> //设置请求超时时间
<span class="cstat-no" title="statement not covered" >    this._worker.timeout = iTimeout;</span>
};
&nbsp;
...
ServantProxy.prototype.rpc_call = function ($RequestId, $FuncName, $AppBuffer) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (argsLen &gt; 2) {
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if(data.request &amp;&amp; data.request.costtime)
...
<span class="cstat-no" title="statement not covered" >        if(data.request &amp;&amp; data.request.costtime)</span>
<span class="cstat-no" title="statement not covered" >            response.costtime = data.request.costtime;</span>
<span class="cstat-no" title="statement not covered" >        response.error    = data.error;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw  {request:data.request, response:response};</span>
    });
};
&nbsp;</pre></td></tr>
</table></pre>
