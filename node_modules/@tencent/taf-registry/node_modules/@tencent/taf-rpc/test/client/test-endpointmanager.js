...
describe("test-endpointmanager", function () {
    this.timeout(0);
    var locator, server1, server2, communicator;
    ...
    it("1. test call locator", function (done) {
        communicator.setProperty("locator", "Test.test.locatorObj@tcp -h 127.0.0.1 -p 14005 -t 10000");
        var prx = communicator.stringToProxy(TRom.NodeTafProxy, "TRom.NodeTafServer.NodeTafObj");
        Promise.all([
