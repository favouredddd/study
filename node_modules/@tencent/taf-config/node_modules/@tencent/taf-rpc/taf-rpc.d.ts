...
import { DyeingObject } from '@tencent/taf-dyeing'
import { EventEmitter } from 'events'
import { BinBuffer, Map, UniAttribute } from '@tencent/taf-stream'
import { Configure, Endpoint } from '@tencent/taf-utils'
...
export interface JceCurrent {
  ...
  /** 仅 TAF 协议有效. 开发者调用 `sendResponse`, 编码之后, 由框架调用该函数返回数据 */
...
export { Promise as promise } from '@tencent/taf-utils'
