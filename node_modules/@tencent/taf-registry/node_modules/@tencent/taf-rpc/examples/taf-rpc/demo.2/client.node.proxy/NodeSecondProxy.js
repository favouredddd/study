...
TRom.NodeSecondProxy = function () {
    this._name   = undefined;
    this._worker = undefined;
}

TRom.NodeSecondProxy.prototype.setTimeout = function (iTimeout) {
    this._worker.timeout = iTimeout;
}

TRom.NodeSecondProxy.prototype.getTimeout = function ( ) {
    return this._worker.timeout;
}


TRom.NodeSecondProxy.prototype.test = function () {
...
TRom.NodeSecondProxy.prototype.yourName = function (sName) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readString(0, true, TafStream.String);
            response.arguments.sUserName = is.readString(2, true, TafStream.String);
    ...
    return this._worker.taf_invoke('yourName', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
